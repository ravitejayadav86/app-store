...
export default function AppDetail() {
    ...
    return (
        <div style={{ minHeight:"100vh", background:"#141414", color:"#fff" }}>
            <style>{`
                .buy-btn { width:100%; padding:16px; background:#e50914; border:none; border-radius:4px; color:#fff; font-size:16px; font-weight:700; cursor:pointer; margin-bottom:12px; }
