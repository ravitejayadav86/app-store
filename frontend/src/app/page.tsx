    ...
    <main className="w-full">
      ...
      <section className="max-w-7xl mx-auto px-8 py-24">
        <div className="flex justify-between items-end mb-12">
          ...
          <Link href="/library" className="text-primary flex items-center gap-2 hover:underline font-semibold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          ...
          {/* Large Card */}
          <Link href="/game/neon-frost" className="md:col-span-2 md:row-span-2 group relative overflow-hidden rounded-ROUND_TWELVE glass-panel frozen-glow cursor-pointer transition-all duration-500 hover:scale-[1.02]">
            ...
            <div className="absolute bottom-0 p-8 w-full font-inter">
              <div className="flex justify-between items-center mb-2">
                <span className="text-primary font-bold text-xs tracking-widest uppercase">Popular Now</span>
                <span className="bg-primary text-on-primary px-3 py-1 rounded-full text-xs font-bold">$59.99</span>
              </div>
              <h3 className="text-3xl font-bold text-on-surface mb-2">Neon Frost: Overdrive</h3>
              <p className="text-on-surface-variant text-sm mb-4">Master the streets in this high-octane racing simulator.</p>
          ...
          {/* Small Card 1 */}
          <Link href="/game/ether-shift" className="group relative overflow-hidden rounded-ROUND_TWELVE glass-panel frozen-glow cursor-pointer transition-all duration-500 hover:scale-[1.02]">
            <div className="aspect-square relative">
              ...
              <div className="absolute bottom-0 p-6 w-full font-inter">
                <h3 className="text-xl font-bold text-on-surface mb-1">Ether Shift</h3>
                <p className="text-on-surface-variant text-xs font-bold uppercase tracking-wider">Tactical Puzzle Strategy</p>
              </div>
            </div>
          </Link>

          {/* Small Card 2 */}
          <Link href="/game/verdant-abyss" className="group relative overflow-hidden rounded-ROUND_TWELVE glass-panel frozen-glow cursor-pointer transition-all duration-500 hover:scale-[1.02]">
            <div className="aspect-square relative">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-surface/90 to-transparent"></div>
              <div className="absolute bottom-0 p-6 w-full flex flex-col justify-end font-inter">
                <h3 className="text-xl font-bold text-on-surface mb-1">Verdant Abyss</h3>
                <p className="text-on-surface-variant text-xs font-bold uppercase tracking-wider">Survival Expedition</p>
              </div>
            </div>
          </Link>

          {/* Horizontal Card */}
          <Link href="/game/circuit-breaker" className="md:col-span-2 group relative overflow-hidden rounded-ROUND_TWELVE glass-panel frozen-glow cursor-pointer transition-all duration-500 hover:scale-[1.02]">
            <div className="flex h-full min-h-[160px]">
              ...
              <div className="w-2/3 p-6 flex flex-col justify-center font-inter">
                <h3 className="text-2xl font-bold text-on-surface mb-1">Circuit Breaker</h3>
                <p className="text-on-surface-variant text-sm mb-3">Hack your way through the digital underworld.</p>
          ...
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-8">
                <div className="flex gap-6 items-start font-inter">
                  <div className="w-20 h-20 rounded-lg glass-panel flex-shrink-0 flex items-center justify-center font-bold text-primary text-xl">OCT</div>
                  <div>
                ...
                <div className="flex gap-6 items-start opacity-70 font-inter">
                  <div className="w-20 h-20 rounded-lg glass-panel flex-shrink-0 flex items-center justify-center font-bold text-on-surface-variant text-xl">NOV</div>
                  <div>
              ...
              <button className="mt-10 px-8 py-3 bg-tertiary-container text-on-tertiary-container rounded-lg font-bold hover:scale-105 transition-all shadow-lg shadow-tertiary-container/30">Pre-order Details</button>
            </div>
            <div className="rounded-2xl overflow-hidden aspect-video border border-white/5 shadow-2xl relative group">
              <div className="absolute inset-0 bg-primary/10 opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
              <img alt="Coming Soon Teaser" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuALVUxM17DE28ymYg6IZSlA0I2oWRVI0lSggn8P00w23zhaNxJyoUW5CA3GyWS0YCMHxmst47KEPtub0u5_b7BoR5hYxSp5f0aJoX4Yara7Ss8KL-MpJzkD4rVNm4XQDaYWvds1KD8dP6pfnWza0smo6zQDYyCE6D5_TQO4ygGiZMs812wN_5LXxbXrPm6cZaQiRB0ta4WxWb5mWWcxRRs6JRVcJbcLyekOq1ulqFaxuhRM3WobFA9agsfwjHILoGHp78AIW6TSAng"/>
            </div>
          </div>
        </div>
      </section>
