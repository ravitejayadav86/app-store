    ...
    <div className="flex flex-col gap-20 pb-20">
      ...
      <section className="px-4 md:px-8">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 w-[300px] h-[300px] bg-white/5 rounded-full blur-[80px] -ml-20 -mb-20" />
      ...
      <section className="px-4 md:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {apps.map((app, index) => (
              <GlassCard key={index} className="flex flex-col gap-6">
      ...
      {/* Premium Banner */}
      <section className="px-4 md:px-8">
        <div className="max-w-7xl mx-auto bg-surface-lowest border border-outline-variant rounded-3xl p-12 relative overflow-hidden flex flex-col items-center text-center gap-6">
