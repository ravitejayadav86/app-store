        ...
        <GlassCard className="p-10 border-outline-variant shadow-2xl relative">
          ...
          <div className="grid grid-cols-2 gap-4">
             <button 
               ...
               className="flex items-center justify-center gap-3 py-4 rounded-2xl border border-outline-variant hover:bg-surface-low hover:border-on-surface/20 transition-all font-bold text-sm bg-surface-low/50"
             >
             ...
             <button 
               ...
               className="flex items-center justify-center gap-3 py-4 rounded-2xl border border-outline-variant hover:bg-surface-low hover:border-primary/20 transition-all font-bold text-sm bg-surface-low/50"
             >
