        ...
        >
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <div className="flex gap-4">
              <Link href={apps.length > 0 && apps[0].id ? `/apps/${apps[0].id}` : "#"}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {apps.map((app: any, index) => (
              ...
              >
                <Link href={app.id ? `/apps/${app.id}` : "#"}>
                  <GlassCard className="flex flex-col gap-6 h-full hover:bg-surface-low transition-all group">
                    <div className="w-16 h-16 rounded-2xl bg-surface-low flex items-center justify-center text-3xl shadow-inner group-hover:scale-105 transition-transform">
                      {app.icon}
                    </div>
                    <div>
                      <h3 className="text-xl font-bold mb-1 group-hover:text-primary transition-colors">{app.title}</h3>
