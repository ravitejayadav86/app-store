  ...
  ({ className, variant = "primary", size = "md", ...props }, ref) => {
    ...
    return (
      <motion.button
        ...
        className={cn(
          "inline-flex items-center justify-center rounded-pill transition-colors disabled:opacity-50 disabled:pointer-events-none cursor-pointer focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background transform-gpu will-change-transform",
          variants[variant],
          sizes[size],
          className
        )}
